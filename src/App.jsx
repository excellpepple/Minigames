  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-800 dark:text-slate-100">
        ...
        {/* HEADER */}
        <header className="sticky top-0 z-30 border-b border-slate-200 dark:border-slate-900 bg-white/80 dark:bg-black/90 backdrop-blur">
            ...
            <nav className="flex items-center gap-4 text-sm font-semibold">
              {[
                ...
                <NavLink
                  ...
                  to={link.to}
                  className={({ isActive }) =>
                    `rounded-md px-3 py-2 transition-colors ${isActive
                      ? "text-sky-700 bg-sky-50 dark:text-sky-400 dark:bg-sky-900/30"
